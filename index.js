...
Menus = [
  // {
  //   name: "core:menu/1",
  //   items: `[{Slot: 19b,id: "minecraft:grass_block",action:{function: "test:1", open: 2}, Count: 1b, tag: {display: {Name: '{"text":"Créatif","color":"green","italic":false}'}}}, {Slot: 21b, id: "minecraft:iron_sword",action:{function: "test:2"}, Count: 1b, tag: {Damage: 0, display: {Name: '{"text":"Survie","color":"red","italic":false}'}}}, {Slot: 23b,action:{function: "test:3"}, id: "minecraft:map", Count: 1b, tag: {display: {Name: '{"text":"Aventure","color":"gold","italic":false}'}}}, {Slot: 25b, id: "minecraft:ender_eye",action:{function: "test:4"}, Count: 1b, tag: {display: {Name: '{"text":"Spectateur","color":"blue","italic":false}'}}}]`
  // },
  // {
  //   name: "core:menu/2",
  //   items: `[{Slot: 10b, id: "minecraft:dark_oak_leaves", Count: 1b}, {Slot: 21b, id: "minecraft:turtle_egg", Count: 1b}, {Slot: 24b, id: "minecraft:dark_oak_leaves", Count: 1b}, {Slot: 32b, id: "minecraft:dark_oak_leaves", Count: 1b}, {Slot: 35b, id: "minecraft:slime_ball", Count: 1b}]`
  // },
  // {
  //   name: "core:menu/3",
  //   items: `[{Slot:1,id:"minecraft:map",action:{function:"core:test"}}]`
  // }
